    ...
    return (
        <section className="min-h-screen bg-slate-50 px-4 py-12 dark:bg-slate-900 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <Link
                    href="/rooms"
                    className="mb-8 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-indigo-500 hover:text-indigo-600 dark:border-white/10 dark:bg-slate-950 dark:text-gray-300"
                >
                    <FaArrowLeft />
                    Back to Rooms
                </Link>
                        ...
                        <div className="mt-10">
                            ...
                            <div className="mt-5 flex flex-wrap gap-3">
                                {room.amenities?.map((item, index) => (
                                    <div
                                        key={index}
                                        className="inline-flex items-center gap-2 rounded-full bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300"
                                    >
                                        <FaCheckCircle />
                                        {item}
                                    </div>
